...
import com.my_shop.dto.OrderHistDto;
import com.my_shop.dto.OrderItemDto;
import com.my_shop.entity.*;
    ...
    public Page<OrderHistDto> getOrderList(String email, Pageable pageable) {
        ...
        for (Order order : orders) {
            ...
            for (OrderItem orderItem : orderItems) {
                ItemImg itemImg = itemImgRepository.findByItemIdAndRepImageYn
